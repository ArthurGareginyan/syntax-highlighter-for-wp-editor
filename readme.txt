...
After installation and activation, the "`Syntax Highlighter for Theme/Plugin Editor`" menu item will appear in the "`Settings`" section of Admin Panel. Click on it in order to view the plugin settings page.
