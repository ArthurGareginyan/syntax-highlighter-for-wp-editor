...
After installation and activation, the "`Theme / Plugin Editor`" menu item will appear in the "`Settings`" section of Admin Area. Click on it in order to view the plugin settings page.
...
You can find the plugin settings page at "`WordPress Admin Area`" -> "`Settings`" -> "`Theme / Plugin Editor`".
...
A. If there is a filetype that is not supported by this plugin, please visit our contact page and fill out the contact form. We will do our best to include it in the next release of plugin.
...
"Syntax Highlighter for Theme/Plugin Editor" is one of the own software projects of [Space X-Chimp](https://www.spacexchimp.com).
...
* To the function 'disable_integrated_codemirror' an unique prefix is added.
...
* Prefixes of the PHP functions changed to ''spacexchimp_p009_.
* Prefixes of the PHP constants changed to ''SPACEXCHIMP_P009_.
