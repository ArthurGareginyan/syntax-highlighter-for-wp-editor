...
Thank you for considering contributing to the plugin "Syntax Highlighter for WP Editor"! The contribution guide can be found in the [CONTRIBUTING.md](https://github.com/ArthurGareginyan/syntax-highlighter-for-wp-editor/blob/master/CONTRIBUTING.md).
...
* [Dedicated Plugin Page on WordPress.org](https://wordpress.org/plugins/syntax-highlighter-for-wp-editor/) - `STILL NOT CREATED`
