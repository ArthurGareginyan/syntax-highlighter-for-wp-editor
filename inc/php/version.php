 ...
 * @since 4.0.1
 */
function SHighlighterForWPE_plugin_version_number() {
    ...
    if ( $new_number == $current_number ) {
        ...
        if ( $info['old_version'] == '1' ) {
            ...
            $info['old_version'] = '0';
            update_option( 'SHighlighterForWPE_service_info', $info );
...
SHighlighterForWPE_plugin_version_number();
