...
When contributing to "Syntax Highlighter for WP Editor" you have to follow some conventions and a simple workflow. It allows me to handle the requests quickly and ensure best quality for the "Syntax Highlighter for WP Editor" core code.
...
The preferred way to report bugs is to use the [GitHub issue tracker](https://github.com/ArthurGareginyan/syntax-highlighter-for-wp-editor/issues). Before reporting a bug, read these pointers.
...
- "Syntax Highlighter for WP Editor" is maintained by me. I don't owe you anything, so be polite. Reports with an indignant or belligerent tone tend to be moved to the bottom of the pile.
...
- Mention which release of "Syntax Highlighter for WP Editor" you're using.
...
- Fork [Syntax Highlighter for WP Editor](https://github.com/ArthurGareginyan/syntax-highlighter-for-wp-editor)
...
By contributing code to "Syntax Highlighter for WP Editor" you:
